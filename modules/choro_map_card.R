#' 
#' Chloropleth Map Card Module
#'
#' This script contains two functions:
#' \code{choro_map_ui} generates the user interface for each card
#' \code{card_choro_map} generates the plot shown in a card
#' 
...
#' 
#' @details
#' \code{choro_map_ui} needs the text that will surround the map on 
...
#' 
#' @details
#' \code{card_choro_map} needs the data, fields, colors, and labels for the map
#' 
